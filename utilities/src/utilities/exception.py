__all__ = ["BaseMethodException", "handle_exception", "handle_http_exception", "handle_tools_exception",
           "find_root_pre_exp"]
...
class BaseMethodException(Exception):
	...
	def __init__(self, pre_exp: Exception | None = None, method: str = "", *, classname: str = "",
	             message: str = "ERROR"):
...
def _handle(e: Exception, exception_type: type[BaseMethodException], func, args0, message):
	...
	raise exception_type(e, **_get_method_classname(func, args0), message=message)
...
def handle_exception(exception_type: type[BaseMethodException] = BaseMethodException, *, message: Any = "ERROR",
                     handle=_handle) -> Any:
	"""
