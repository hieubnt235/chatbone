...
env_file = find_dotenv(".env.datastore")
...
class DatastoreSettings(Settings):
    ...
    model_config = SettingsConfigDict(env_prefix="datastore_", env_file=env_file)
...
datastore_settings = DatastoreSettings(env_file=env_file)
