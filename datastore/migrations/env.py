...
from datastore.settings import datastore_settings

db = datastore_settings.db
...
db_metadata = dict(
    datastore_db=DatastoreBase.metadata,  # document_db=DocumentBase.metadata
)
...
try:
    ...
    url_params[4] = int(url_params[4])  # port
